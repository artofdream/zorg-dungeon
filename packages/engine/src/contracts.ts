...
// Canonical copy also lives at fixtures/contracts/catalog.json (kept in sync
// by the corpus test). This module stays Node-free so the web app can import it.
...
export function loadContracts(): ContractRecord[] {
  return CONTRACTS.map((c) => ({ ...c, levelIds: [...c.levelIds] }));
}
